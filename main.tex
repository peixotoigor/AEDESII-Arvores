...
\titlespacing*{\subsection}{0pt}{0.9ex plus .2ex minus .2ex}{0.3ex plus .1ex}
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Liderança de desempenho por cenário:} A Árvore Patricia demonstrou superioridade consistente de desempenho e consumo de nós em processamento de strings com prefixos compartilhados (alocando 86,8\% menos nós que a Trie convencional e superando-a em tempo de busca por nó). A Árvore Splay revelou-se altamente adaptativa para padrões de consulta com forte localidade temporal de referência, reduzindo o tempo de consulta em 21,4\% sob distribuição de Zipf frente à carga uniforme. A KD-Tree demonstrou expressiva vantagem de desempenho em consultas espaciais de vizinhança em baixa dimensão, superando a varredura linear por 91,1 vezes em $\mathbb{R}^2$.
