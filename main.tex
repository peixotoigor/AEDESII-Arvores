...
\usepackage[left=1.7cm,right=1.7cm,top=1.55cm,bottom=1.55cm]{geometry}
...
\titlespacing*{\subsection}{0pt}{0.4ex plus .1ex minus .1ex}{0.1ex plus .1ex}
...
As estruturas foram modeladas conceitualmente e implementadas em C++20, aplicando o princípio RAII com desalocação recursiva nos destrutores e gerência explícita de ponteiros nas árvores binárias para neutralizar riscos de estouro de pilha sob entradas degeneradas. Optou-se por ponteiros nativos em vez de \texttt{std::unique\_ptr} para manter a legibilidade dos algoritmos de rotação, onde a transferência de subárvores entre nós exige reatribuição direta de ponteiros.
...
\begin{minipage}[t]{0.49\linewidth}
  \centering
  \includegraphics[width=0.92\linewidth]{imagens/cenario1_prefixos.png}
...
\begin{minipage}[t]{0.49\linewidth}
  \centering
  \includegraphics[width=0.92\linewidth]{imagens/cenario2_altura_ordenada.png}
...
\begin{minipage}[t]{0.49\linewidth}
  \centering
  \includegraphics[width=0.92\linewidth]{imagens/cenario3_localidade_splay.png}
...
\begin{minipage}[t]{0.49\linewidth}
  \centering
  \includegraphics[width=0.92\linewidth]{imagens/cenario4_maldicao_kdtree.png}
