...
\section{Fundamentação Teórica das Estruturas}
...
\section{Demonstração Visual dos Algoritmos}
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Liderança de desempenho por cenário:} A Árvore Patricia demonstrou inequívoca superioridade em processamento de strings com prefixos compartilhados (alocando 86,8\% menos nós que a Trie convencional e superando-a em tempo de busca por nó). A Árvore Splay revelou-se altamente adaptativa para padrões de consulta com forte localidade temporal de referência, reduzindo o tempo de consulta em 21,4\% sob distribuição de Zipf frente à carga uniforme. A KD-Tree provou-se imbatível em consultas espaciais de vizinhança em baixa dimensão, superando a varredura linear por 91,1 vezes em $\mathbb{R}^2$.
